...
# Add to a hash
superheroes["Barry Alen"] = "Flash"
puts superheroes["Barry Alen"]
...
puts "Hash Key Lisa Morel : " + superheroes.has_key?("Lisa Morel").to_s
puts "Hash Value Batman : " + superheroes.has_value?("Batman").to_s
puts "Is Hash Empty? : " + superheroes.empty?.to_s
puts "Size of Hash: " + superheroes.size.to_s

# Delete a key value
superheroes.delete("Barry Alen")
puts "Size of Hash: " + superheroes.size.to_s
