...
puts full_name.include?("Rahul")

# Get the length of a string
puts "Size of the name: " + full_name.size.to_s
...
puts full_name.start_with?("Shinde")

# Return the index for the match
puts "Index: " + full_name.index("Vishwanath").to_s
